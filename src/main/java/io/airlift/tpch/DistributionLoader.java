...
{
    public static <R extends Readable & Closeable> Map<String, Distribution> loadDistribution(InputSupplier<R> supplier)
            throws IOException
    {
        Iterator<String> iterator = filter(CharStreams.readLines(supplier).iterator(), new Predicate<String>()
        {
            @Override
