...
import static io.airlift.tpch.LineItemGenerator.createQuantityRandom;
import static io.airlift.tpch.LineItemGenerator.createShipDateRandom;
import static io.airlift.tpch.LineItemGenerator.createTaxRandom;
import static io.airlift.tpch.PartGenerator.calculatePartPrice;
            ...
            extends AbstractIterator<Order>
    {
        ...
        private Order makeOrder(long index)
        {
            ...
            return new Order(
                    ...
                    String.format("Clerk#%09d", clerkRandom.nextValue()),
                    0,
